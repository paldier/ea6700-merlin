...
/* Build date and time */
#define BUILD_DATE "2019-12-12T12:44:59Z"
...
/* C compiler command */
#define LLDP_CC "arm-brcm-linux-uclibcgnueabi-gcc -std=gnu99  -fdiagnostics-show-option -pipe -Wall -W -Wextra -Wformat -Wformat-security -Wfatal-errors -Wcast-align -Winline -Wpointer-arith -fno-omit-frame-pointer -Wno-unused-parameter -Wno-missing-field-initializers -Wno-sign-compare -fstack-protector -fstack-protector-all  -D_FORTIFY_SOURCE=2 -D_GNU_SOURCE -g -O2 -I/home/paldier/68u/release/src-rt-6.x.4708/router/arm-uclibc/stage/usr/include "

/* Linker compiler command */
#define LLDP_LD "arm-brcm-linux-uclibcgnueabi-ld  -Wl,-z,relro -Wl,-z,now  -L/home/paldier/68u/release/src-rt-6.x.4708/router/lldpd-0.9.8/lib -lm -L/home/paldier/68u/release/src-rt-6.x.4708/router/arm-uclibc/stage/usr/lib -ljansson -L/home/paldier/68u/release/src-rt-6.x.4708/router/json-c/.libs -ldl "
...
#define MIN_LINUX_KERNEL_VERSION "2.6.11"
...
#define PACKAGE_STRING "lldpd 0.9.8"
