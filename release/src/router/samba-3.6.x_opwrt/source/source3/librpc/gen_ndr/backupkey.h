...
struct bkrp_exported_RSA_key_pair {
	...
	DATA_BLOB modulus;/* [subcontext_size(256),flag(LIBNDR_FLAG_REMAINING),subcontext(0)] */
	...
	DATA_BLOB exponent2;/* [subcontext(0),flag(LIBNDR_FLAG_REMAINING),subcontext_size(128)] */
	DATA_BLOB coefficient;/* [subcontext(0),flag(LIBNDR_FLAG_REMAINING),subcontext_size(128)] */
	DATA_BLOB private_exponent;/* [flag(LIBNDR_FLAG_REMAINING),subcontext_size(256),subcontext(0)] */
