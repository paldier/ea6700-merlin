...
struct NEGOTIATE_MESSAGE {
	...
	const char * DomainName;/* [subcontext_size(DomainNameLen),relative,flag(ndr_ntlmssp_negotiated_string_flags(NTLMSSP_NEGOTIATE_OEM)),subcontext(0)] */
...
struct AV_PAIR_LIST {
	uint32_t count;
	struct AV_PAIR *pair;
}/* [nopush,gensize,nopull,flag(LIBNDR_FLAG_NOALIGN)] */;
...
struct CHALLENGE_MESSAGE {
	...
	const char * TargetName;/* [subcontext_size(TargetNameLen),relative,flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),subcontext(0)] */
	uint32_t NegotiateFlags;
...
struct AUTHENTICATE_MESSAGE {
	...
	union ntlmssp_NTLM_RESPONSE *NtChallengeResponse;/* [subcontext(0),switch_is(NtChallengeResponseLen),subcontext_size(NtChallengeResponseMaxLen),relative] */
	uint16_t DomainNameLen;/* [value(ndr_ntlmssp_string_length(NegotiateFlags,DomainName))] */
	uint16_t DomainNameMaxLen;/* [value(DomainNameLen)] */
	const char * DomainName;/* [flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),relative,subcontext_size(DomainNameLen),subcontext(0)] */
	uint16_t UserNameLen;/* [value(ndr_ntlmssp_string_length(NegotiateFlags,UserName))] */
	uint16_t UserNameMaxLen;/* [value(UserNameLen)] */
	const char * UserName;/* [subcontext(0),relative,subcontext_size(UserNameLen),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags))] */
	uint16_t WorkstationLen;/* [value(ndr_ntlmssp_string_length(NegotiateFlags,Workstation))] */
	uint16_t WorkstationMaxLen;/* [value(WorkstationLen)] */
	const char * Workstation;/* [relative,subcontext_size(WorkstationLen),flag(ndr_ntlmssp_negotiated_string_flags(r->NegotiateFlags)),subcontext(0)] */
