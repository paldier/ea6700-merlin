...
struct PAC_BUFFER {
	...
	union PAC_INFO *info;/* [subcontext(0),switch_is(type),subcontext_size(_subcontext_size_PAC_INFO(r,ndr->flags)),relative,flag(LIBNDR_FLAG_ALIGN8)] */
	uint32_t _pad;/* [value(0)] */
}/* [nopush,public,nopull,noprint] */;
