...
union eventlog6_EvtRpcVariantUnion {
	...
	const char *stringVal;/* [charset(UTF16),case(EvtRpcVarTypeString),unique] */
...
struct eventlog6_EvtRpcRemoteSubscriptionNext {
	...
	struct {
		uint32_t *numActualRecords;/* [ref] */
		uint32_t **eventDataIndices;/* [range(0,MAX_RPC_RECORD_COUNT),size_is(,*numActualRecords),ref] */
		uint32_t **eventDataSizes;/* [ref,size_is(,*numActualRecords),range(0,MAX_RPC_RECORD_COUNT)] */
		uint32_t *resultBufferSize;/* [ref] */
...
struct eventlog6_EvtRpcClearLog {
	struct {
		...
		const char *backupPath;/* [unique,charset(UTF16),range(0,MAX_RPC_FILE_PATH_LENGTH)] */
		uint32_t flags;
	} in;
...
struct eventlog6_EvtRpcExportLog {
	struct {
		...
		const char *query;/* [range(1,MAX_RPC_QUERY_LENGTH),charset(UTF16),ref] */
		const char *backupPath;/* [ref,charset(UTF16),range(1,MAX_RPC_FILE_PATH_LENGTH)] */
		uint32_t flags;
	} in;
...
struct eventlog6_EvtRpcGetChannelList {
	...
	struct {
		...
		const char ***channelPaths;/* [ref,size_is(,*numChannelPaths),charset(UTF16),range(0,MAX_RPC_CHANNEL_COUNT)] */
		WERROR result;
	} out;
...
struct eventlog6_EvtRpcGetPublisherListForChannel {
	...
	struct {
		uint32_t *numPublisherIds;/* [ref] */
		const char ***publisherIds;/* [ref,charset(UTF16),size_is(,*numPublisherIds),range(0,MAX_RPC_PUBLISHER_COUNT)] */
		WERROR result;
	} out;
