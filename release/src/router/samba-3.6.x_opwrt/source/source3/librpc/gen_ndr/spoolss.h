...
struct spoolss_DeviceMode {
	...
	DATA_BLOB driverextra_data;/* [subcontext_size(__driverextra_length),flag(LIBNDR_FLAG_REMAINING),subcontext(0)] */
}/* [gensize,public] */;
...
}/* [public,gensize,relative_base,flag(LIBNDR_FLAG_RELATIVE_REVERSE),nodiscriminant] */;
...
}/* [nodiscriminant,flag(LIBNDR_FLAG_RELATIVE_REVERSE),relative_base,gensize,public] */;
...
}/* [gensize,public,relative_base,flag(LIBNDR_FLAG_RELATIVE_REVERSE),nodiscriminant] */;
...
}/* [nodiscriminant,flag(LIBNDR_FLAG_RELATIVE_REVERSE),relative_base,public] */;
...
}/* [flag(LIBNDR_FLAG_RELATIVE_REVERSE),nodiscriminant,gensize,public,relative_base] */;
...
struct spoolss_OSVersion {
	...
	const char * extra_string;/* [subcontext(0),flag(LIBNDR_FLAG_STR_NULLTERM|LIBNDR_FLAG_ALIGN2),subcontext_size(256)] */
}/* [gensize,public] */;
...
}/* [relative_base,gensize,public,nodiscriminant,flag(LIBNDR_FLAG_RELATIVE_REVERSE)] */;
...
struct spoolss_PrinterEnumValues {
	...
	DATA_BLOB *data;/* [subcontext(0),relative,subcontext_size(data_length),flag(LIBNDR_FLAG_REMAINING|ndr_spoolss_PrinterEnumValues_align(r->type))] */
...
struct spoolss_GetJob {
	...
	struct {
		union spoolss_JobInfo *info;/* [switch_is(level),subcontext(4),unique,subcontext_size(offered)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriver {
	...
	struct {
		union spoolss_DriverInfo *info;/* [switch_is(level),subcontext(4),unique,subcontext_size(offered)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrinterDriverDirectory {
	...
	struct {
		union spoolss_DriverDirectoryInfo *info;/* [unique,subcontext_size(offered),switch_is(level),subcontext(4)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetPrintProcessorDirectory {
	...
	struct {
		union spoolss_PrintProcessorDirectoryInfo *info;/* [subcontext_size(offered),unique,subcontext(4),switch_is(level)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_GetForm {
	...
	struct {
		union spoolss_FormInfo *info;/* [subcontext(4),switch_is(level),subcontext_size(offered),unique] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
...
struct spoolss_EnumPrinterKey {
	...
	struct {
		...
		union spoolss_KeyNames *key_buffer;/* [switch_is(*_ndr_size),subcontext(0),ref,subcontext_size(*_ndr_size*2)] */
		uint32_t *needed;/* [ref] */
		WERROR result;
	} out;
